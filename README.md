...
- **Admin** (client) — panel /admin pour validation pros, lifecycle, wallet override, stats
...
| notifs-pack | Pack notifications etendu (textes client, B/E/F/G/I, toggles, cron no-match) | ✅ |
