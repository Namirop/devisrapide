...
const LEADS: LeadSeed[] = [
  ...
  { ref: "L4", clientEmail: CLIENTS[3].email, categorySlug: "sols-murs", subCategorySlug: "peinture", city: "NAMUR", status: "ASSIGNED", urgency: "PLANNED", description: "Repeindre salon + cuisine + couloir, environ 60m2.", isExclusive: false, daysAgo: 1 },
  ...
  { ref: "L6", clientEmail: CLIENTS[0].email, categorySlug: "serrurerie-securite", subCategorySlug: "ouverture-porte", city: "MONS", status: "ACCEPTED", urgency: "URGENT", description: "Porte d'entree claquee, cle a l'interieur. Besoin d'ouverture urgente.", isExclusive: false, daysAgo: 1 },
  ...
  { ref: "L8", clientEmail: CLIENTS[2].email, categorySlug: "electricite", subCategorySlug: "depannage-electrique", city: "BXL_IXL", status: "COMPLETED", urgency: "SOON", description: "Panne generale, plus de courant dans tout l'appartement.", isExclusive: false, daysAgo: 21 },
  { ref: "L9", clientEmail: CLIENTS[3].email, categorySlug: "plomberie", subCategorySlug: "debouchage-canalisation", city: "CHARLEROI", status: "EXPIRED", urgency: "URGENT", description: "WC bouches.", isExclusive: false, daysAgo: 5 },
  { ref: "L10", clientEmail: CLIENTS[4].email, categorySlug: "chauffage", subCategorySlug: "entretien-chaudiere", city: "GAND", status: "CANCELLED", urgency: "PLANNED", description: "Entretien annuel chaudiere - client a finalement trouve via voisin.", isExclusive: false, daysAgo: 3 },
  { ref: "L11", clientEmail: CLIENTS[0].email, categorySlug: "serrurerie-securite", subCategorySlug: "remplacement-serrure", city: "MONS", status: "ASSIGNED", urgency: "URGENT", description: "Remplacement serrure 3 points apres effraction.", isExclusive: true, daysAgo: 0 },
  { ref: "L12", clientEmail: CLIENTS[1].email, categorySlug: "renovation-globale", subCategorySlug: "transformation-complete", city: "NAMUR", status: "PENDING_MATCH", urgency: "FLEXIBLE", description: "Renovation complete maison 4 facades, environ 150m2.", isExclusive: false, daysAgo: 1 },
];
