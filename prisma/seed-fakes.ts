...
const BE = {
  ...
  BXL_IXL: { postalCode: "1050", city: "Ixelles", lat: 50.8267, lng: 4.365 },
} as const;
...
const PROS: ProSeed[] = [
  {
    ...
    description:
      "Specialiste toiture et zinguerie depuis 2010. Equipe de 4 couvreurs.",
    city: "BRUXELLES",
  ...
  },
  {
    ...
    description:
      "Electricien agree pour mise en conformite et installation neuve.",
    city: "LIEGE",
  ...
  },
  {
    ...
    city: "MONS",
    categorySlugs: ["serrurerie-securite", "plomberie-chauffage-urgents"],
    validationStatus: "VALIDATED",
  ...
  },
  {
    ...
    rejectedReason:
      "Numero de TVA non verifiable et absence d'attestation d'assurance professionnelle.",
    walletBalanceCents: 0,
    autoAccept: false,
  },
  {
    ...
    suspensionReason:
      "Multiples plaintes clients pour devis non honores - dossier en cours d'analyse.",
    walletBalanceCents: 0,
    autoAccept: false,
  },
];
...
const CLIENTS: ClientSeed[] = [
  {
    email: "marie.lambert" + FAKE_EMAIL_SUFFIX,
    firstName: "Marie",
    lastName: "Lambert",
    phone: "+32471111111",
  },
  {
    email: "thomas.dubois" + FAKE_EMAIL_SUFFIX,
    firstName: "Thomas",
    lastName: "Dubois",
    phone: "+32472222222",
  },
  {
    email: "sophie.martin" + FAKE_EMAIL_SUFFIX,
    firstName: "Sophie",
    lastName: "Martin",
    phone: "+32473333333",
  },
  {
    email: "lucas.petit" + FAKE_EMAIL_SUFFIX,
    firstName: "Lucas",
    lastName: "Petit",
    phone: "+32474444444",
  },
  {
    email: "julie.moreau" + FAKE_EMAIL_SUFFIX,
    firstName: "Julie",
    lastName: "Moreau",
    phone: "+32475555555",
  },
...
const LEADS: LeadSeed[] = [
  {
    ...
    subCategorySlug: "installation-complete",
    city: "BRUXELLES",
    status: "PENDING_MATCH",
    urgency: "URGENT",
    description:
      "Toiture a refaire integralement, environ 80m2, ardoises naturelles.",
    isExclusive: false,
    daysAgo: 0,
  },
  {
    ...
    subCategorySlug: "mise-en-conformite",
    city: "LIEGE",
    status: "PENDING_MATCH",
    urgency: "SOON",
    description: "Mise en conformite tableau electrique maison annee 1970.",
    isExclusive: false,
    daysAgo: 0,
  },
  {
    ...
    subCategorySlug: "fuite-depannage",
    city: "CHARLEROI",
    status: "ASSIGNED",
    urgency: "URGENT",
    description: "Fuite sous evier cuisine, eau qui suinte depuis ce matin.",
    isExclusive: false,
    daysAgo: 0,
  },
  {
    ...
    categorySlug: "sols-murs",
    subCategorySlug: "peinture",
    city: "NAMUR",
    status: "ASSIGNED",
    urgency: "PLANNED",
    description: "Repeindre salon + cuisine + couloir, environ 60m2.",
    isExclusive: false,
    daysAgo: 1,
  },
  {
    ...
    subCategorySlug: "nouvelle-installation",
    city: "GAND",
    status: "ACCEPTED",
    urgency: "SOON",
    description: "Remplacer chaudiere gaz par pompe a chaleur air-eau.",
    isExclusive: false,
    daysAgo: 2,
  },
  {
    ref: "L6",
    clientEmail: CLIENTS[0].email,
    categorySlug: "serrurerie-securite",
    subCategorySlug: "ouverture-porte",
    city: "MONS",
    status: "ACCEPTED",
    urgency: "URGENT",
    description:
      "Porte d'entree claquee, cle a l'interieur. Besoin d'ouverture urgente.",
    isExclusive: false,
    daysAgo: 1,
  },
  {
    ...
    status: "COMPLETED",
    urgency: "FLEXIBLE",
    description: "Installation electrique complete pour extension 30m2.",
    isExclusive: false,
    daysAgo: 14,
  },
  {
    ...
    clientEmail: CLIENTS[2].email,
    categorySlug: "electricite",
    subCategorySlug: "depannage-electrique",
    city: "BXL_IXL",
    status: "COMPLETED",
    urgency: "SOON",
    description: "Panne generale, plus de courant dans tout l'appartement.",
    isExclusive: false,
    daysAgo: 21,
  },
  {
    ...
    clientEmail: CLIENTS[3].email,
    categorySlug: "plomberie",
    subCategorySlug: "debouchage-canalisation",
    city: "CHARLEROI",
    status: "EXPIRED",
    urgency: "URGENT",
    description: "WC bouches.",
    isExclusive: false,
    daysAgo: 5,
  },
  {
    ...
    clientEmail: CLIENTS[4].email,
    categorySlug: "chauffage",
    subCategorySlug: "entretien-chaudiere",
    city: "GAND",
    status: "CANCELLED",
    urgency: "PLANNED",
    description:
      "Entretien annuel chaudiere - client a finalement trouve via voisin.",
    isExclusive: false,
    daysAgo: 3,
  },
  {
    ...
    clientEmail: CLIENTS[0].email,
    categorySlug: "serrurerie-securite",
    subCategorySlug: "remplacement-serrure",
    city: "MONS",
    status: "ASSIGNED",
    urgency: "URGENT",
    description: "Remplacement serrure 3 points apres effraction.",
    isExclusive: true,
    daysAgo: 0,
  },
  {
    ref: "L12",
    clientEmail: CLIENTS[1].email,
    categorySlug: "renovation-globale",
    subCategorySlug: "transformation-complete",
    city: "NAMUR",
    status: "PENDING_MATCH",
    urgency: "FLEXIBLE",
    description: "Renovation complete maison 4 facades, environ 150m2.",
    isExclusive: false,
    daysAgo: 1,
  },
];
...
const ASSIGNMENTS: AssignmentSeed[] = [
  ...
  },
  {
    ...
    adminGifted: false,
    followupStatus: "PENDING",
    refusalReason: "Hors zone d'intervention",
  },
  {
    leadRef: "L11",
    proEmail: PROS[5].email,
...
const STANDALONE_TXS: StandaloneTxSeed[] = [
  {
    ...
    type: "TOPUP",
    amountCents: 100000,
    description: "Recharge Stripe pack Boost",
    daysAgo: 30,
  },
  {
    proEmail: PROS[2].email,
    type: "ADMIN_CREDIT",
    amountCents: 20000,
    description: "Credit gratuit bienvenue",
    reason: "Geste commercial onboarding",
    daysAgo: 20,
  },
  {
    proEmail: PROS[2].email,
    type: "ADMIN_DEBIT",
    amountCents: -20000,
    description: "Correction credit accidentel",
    reason: "Annulation geste commercial (double credit)",
    daysAgo: 18,
  },
  {
    proEmail: PROS[3].email,
    type: "TOPUP",
    amountCents: 50000,
    description: "Recharge Stripe pack Decouverte",
    daysAgo: 15,
  },
  {
    proEmail: PROS[4].email,
  ...
  },
  {
    ...
    type: "TOPUP",
    amountCents: 30000,
    description: "Recharge Stripe complementaire",
    daysAgo: 10,
  },
  {
    proEmail: PROS[5].email,
...
export async function seedFakes(prisma: PrismaClient) {
  ...
  for (const p of PROS) {
    ...
    for (const slug of p.categorySlugs) {
      ...
      if (!cat)
        throw new Error(`[seed-fakes] category slug introuvable: ${slug}`);
  ...
  const leadByRef = new Map<
    string,
    { id: string; sharedPriceCents: number; exclusivePriceCents: number }
  >();
  for (const l of LEADS) {
    const cat = catBySlug.get(l.categorySlug);
    if (!cat)
      throw new Error(
        `[seed-fakes] category slug introuvable: ${l.categorySlug}`,
      );
    const sub = subBySlug.get(`${l.categorySlug}/${l.subCategorySlug}`);
    if (!sub)
      throw new Error(
        `[seed-fakes] sub-category slug introuvable: ${l.categorySlug}/${l.subCategorySlug}`,
      );
    const client = CLIENTS.find((c) => c.email === l.clientEmail);
    if (!client)
      throw new Error(`[seed-fakes] client introuvable: ${l.clientEmail}`);
    ...
    const lead = await prisma.lead.create({
      data: {
        ...
        sharedLeadPriceCentsSnapshot:
          sub.sharedLeadPriceCents ?? cat.defaultSharedLeadPriceCents,
        exclusiveLeadPriceCentsSnapshot:
          sub.exclusiveLeadPriceCents ?? cat.defaultExclusiveLeadPriceCents,
        status: l.status,
        createdAt,
  ...
  for (const a of ASSIGNMENTS) {
    ...
    if (!lead)
      throw new Error(`[seed-fakes] lead ref introuvable: ${a.leadRef}`);
    const pro = proUsers.get(a.proEmail);
    if (!pro)
      throw new Error(`[seed-fakes] pro email introuvable: ${a.proEmail}`);
    const priceCents = a.adminGifted
      ? 0
      : a.isExclusive
        ? lead.exclusivePriceCents
        : lead.sharedPriceCents;
    const acceptedAt =
      a.status === "ACCEPTED" ? new Date(Date.now() - 86_400_000) : null;
    const refusedAt =
      a.status === "REFUSED" ? new Date(Date.now() - 86_400_000) : null;
  ...
  for (const t of STANDALONE_TXS) {
    ...
    if (!pro)
      throw new Error(`[seed-fakes] pro email introuvable: ${t.proEmail}`);
  ...
  const auditEntries = [
    {
      action: "PRO_VALIDATED" as const,
      targetEmail: PROS[1].email,
      metadata: { companyName: PROS[1].companyName },
    },
    {
      action: "PRO_VALIDATED" as const,
      targetEmail: PROS[4].email,
      metadata: { companyName: PROS[4].companyName },
    },
    {
      action: "PRO_REJECTED" as const,
      targetEmail: PROS[6].email,
      metadata: { reason: PROS[6].rejectedReason },
    },
    {
      action: "PRO_SUSPENDED" as const,
      targetEmail: PROS[7].email,
      metadata: { reason: PROS[7].suspensionReason },
    },
    {
      action: "WALLET_CREDIT_ADDED" as const,
      targetEmail: PROS[2].email,
      metadata: { amountCents: 20000, reason: "Geste commercial onboarding" },
    },
    {
      action: "WALLET_DEBIT_ADDED" as const,
      targetEmail: PROS[2].email,
      metadata: {
        amountCents: 20000,
        reason: "Annulation geste commercial (double credit)",
