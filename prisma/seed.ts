...
// ─── CATALOGUE ─────────────────────────────────────────────
// Prix en centimes. Provisoires - a valider avec client.
...
// Aligné sur la liste métier fournie par client (référence "Question 6").
//
...
async function seedAdmin() {
  // Admin principal (client en prod, ou un compte d'eval). Toujours seede
