    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          effectuées sur la plateforme pourra être transmise électroniquement au
          professionnel en fin de mois. DevisRapide se réserve le droit de faire
          évoluer ultérieurement son système de facturation vers un
      ...
      <ul>
        ...
        <li>
          ...
          d&apos;Auto-Accept (activation, zones d&apos;intervention,
          catégories). Tout lead acheté via ce mode est définitif.
        </li>
        <li>
      ...
      <p>
        En conséquence, <strong>aucun remboursement en numéraire</strong> (cash)
        ne pourra être exigé pour les motifs suivants&nbsp;:
      </p>
      <ul>
      ...
      <p>
        ...
        <strong> maximum de 48 h</strong> pourront faire l&apos;objet d&apos;une
      ...
      <p>
        Le professionnel s&apos;engage à utiliser les données clients uniquement
        dans le cadre du traitement des demandes reçues via la plateforme. Toute
        utilisation abusive, revente de données ou détournement de finalité
        entraînera l&apos;exclusion immédiate et d&apos;éventuelles poursuites
        judiciaires. L&apos;utilisation de systèmes de data scraping est
      ...
      <p>
        ...
        <strong>droit belge</strong>. Les tribunaux de l&apos;arrondissement de
