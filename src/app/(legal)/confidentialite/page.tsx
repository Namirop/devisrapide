...
export default function ConfidentialitePage() {
  return (
    ...
    >
      ...
      <p>
        Le traitement des données est géré par DevisRapide ({COMPANY.VAT_NUMBER}
        ).
      </p>
      ...
      <p>
        <strong>Cookies analytiques (mesure d&apos;audience)&nbsp;:</strong> non
        utilisés au lancement V1. L&apos;activation future d&apos;un outil de
        mesure d&apos;audience anonymisée (par exemple Google Analytics) sera
        précédée d&apos;une mise à jour de cette politique et de l&apos;ajout
        d&apos;un véritable choix de consentement dans le bandeau cookies. Pour
        le détail des cookies actuellement déposés, consultez notre{" "}
