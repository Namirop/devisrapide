  ...
  return (
    <LegalContent title="Politique cookies" updatedAt="Mai 2026 (v1.0)">
      ...
      <p>
        ...
        pixel marketing, aucun traceur tiers n&apos;est déposé sur votre
        navigateur au lancement V1.
      </p>
      <p>
        Conformément au RGPD (art. 82 / e-Privacy), aucun consentement
        n&apos;est requis pour les cookies strictement nécessaires. Vous restez
        libre de les bloquer via les paramètres de votre navigateur, au prix de
      ...
      <ul>
        <li>
          ...
          <em>checkout.stripe.com</em>) pour la prévention de la fraude. Voir la{" "}
          <a
      ...
      <p>
        ...
        navigateur via l&apos;API Push standard (techniquement pas un cookie).
        Vous pouvez révoquer cet abonnement à tout moment depuis les paramètres
        de votre navigateur ou de votre dashboard.
      </p>

      <h2>Cookies analytiques (mesure d&apos;audience)</h2>
      <p>
        <strong>Non utilisés au lancement V1.</strong> L&apos;activation future
        d&apos;un outil de mesure d&apos;audience anonymisée (par exemple Google
        Analytics) sera précédée d&apos;une mise à jour de cette politique et de
        l&apos;ajout d&apos;un véritable choix de consentement (Accepter /
      ...
      <p>
        ...
        publicité programmatique, retargeting, fingerprinting.
      </p>
