...
export default function MentionsLegalesPage() {
  return (
    <LegalContent title="Mentions légales" updatedAt="[À COMPLÉTER — client]">
      ...
      <ul>
        <li>
          <strong>Raison sociale&nbsp;:</strong> [À COMPLÉTER — client]
        </li>
        <li>
          <strong>Forme juridique&nbsp;:</strong> [À COMPLÉTER — client]
        </li>
        <li>
        ...
        <li>
          <strong>Numéro de TVA&nbsp;:</strong> BE [À COMPLÉTER — client]
        </li>
        <li>
          <strong>Siège social&nbsp;:</strong> [À COMPLÉTER — client],
          Bruxelles, Belgique
        </li>
        <li>
