    ...
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <div className="mx-auto max-w-[720px] px-6 pt-8 pb-2">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Les {EMAIL_PREVIEWS.length} emails envoyés par la plateforme, rendus
          avec les vrais templates et des données d&apos;exemple fictives.
          Page interne de relecture — non référencée.
        </p>
      </div>
