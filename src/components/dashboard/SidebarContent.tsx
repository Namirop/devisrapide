...
/**
 * Contenu de la Sidebar (logo + nav + bottom block + logout). Server
 * Component utilise par :
 *  - <Sidebar> wrapper desktop (hidden lg:flex).
 *  - <MobileSidebar> drawer mobile via Sheet.
 *
 * Fetch les compteurs PENDING + ACCEPTED ce mois en parallele. Si le
 * meme proProfileId est rendu deux fois dans la meme page (cas mobile :
 * Sidebar desktop hidden + drawer mobile), les queries sont identiques
 * et Prisma + React les dedupent en pratique.
 */
