...
// Bandeau « primes de la Région wallonne » ; le CTA mène au formulaire
// /demande.
...
export function WalloniaBanner() {
  return (
    <section id="primes" className="relative scroll-mt-20 lg:scroll-mt-16">
      <div className="mx-auto max-w-[1400px] px-6 py-10 lg:py-13">
        <Reveal>
          <div
            ...
            <div className="grid items-center gap-6 p-6 lg:grid-cols-[auto_1.4fr_1fr] lg:gap-8 lg:p-7">
              <div className="shrink-0">
                <Image
                  ...
                  width={162}
                  height={108}
                  className="h-[108px] w-[162px] rounded-md object-cover shadow-sm ring-1 ring-yellow-300"
                />
              </div>
