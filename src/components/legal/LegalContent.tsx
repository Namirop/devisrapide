  ...
  return (
    <article
      className={cn(
        ...
        "[&_h1]:mb-2 [&_h1]:text-[32px] [&_h1]:font-bold [&_h1]:tracking-tight [&_h1]:text-slate-900",
        "[&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-[20px] [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-slate-900",
