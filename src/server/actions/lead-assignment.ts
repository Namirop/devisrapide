...
export async function acceptLeadAssignment(
  ...
  try {
    ...
    // Push E (client) "Lead plus disponible" — fire-and-forget aux pros
    ...
    // push. Pas d'email V1 (client) pour eviter le spam.
    ...
    if (
      ...
      // Email I — client : pendant email du push, opt-in. Fire-and-forget.
      if (assignment.proUser.email) {
...
// pour analyses client et eviter de re-notifier ce pro sur le meme lead.
